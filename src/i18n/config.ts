...
import deTrace from '@/i18n/locales/de/trace.json';
import deSlide from '@/i18n/locales/de/slide.json';
import enCommon from '@/i18n/locales/en/common.json';
import enGame from '@/i18n/locales/en/game.json';
import enHome from '@/i18n/locales/en/home.json';
import enMaze from '@/i18n/locales/en/maze.json';
import enTrace from '@/i18n/locales/en/trace.json';
import enSlide from '@/i18n/locales/en/slide.json';
import esCommon from '@/i18n/locales/es/common.json';
import esGame from '@/i18n/locales/es/game.json';
import esHome from '@/i18n/locales/es/home.json';
import esMaze from '@/i18n/locales/es/maze.json';
import esTrace from '@/i18n/locales/es/trace.json';
import esSlide from '@/i18n/locales/es/slide.json';
...
import frTrace from '@/i18n/locales/fr/trace.json';
import frSlide from '@/i18n/locales/fr/slide.json';
...
import itTrace from '@/i18n/locales/it/trace.json';
import itSlide from '@/i18n/locales/it/slide.json';

export const I18N_NAMESPACES = ['common', 'home', 'game', 'maze', 'trace', 'slide'] as const;
